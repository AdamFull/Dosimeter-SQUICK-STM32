...
const char* S_SENSOR_AREA = "Плoщ дaтчикa:";
...
const char* S_ADVANCED = "Advanced";
const char* S_RESET = "Reset";
const char* S_BACKGROUND = "Background";
const char* S_SAMPLE = "sample";
const char* S_PRESSSET = "Press set";
const char* S_SUCCESS = "Ready";
const char* S_ACTIVITY = "Activity";
const char* S_TONE = "Sound:";
...
const char* S_MEANS = "Meansures:";
const char* S_BEGIN = "Begin";
const char* S_MODE_SEC = "One sec";
const char* S_ALARM = "Alarm:";
const char* S_GCOUNTER = "Sensor";
const char* S_CUSTOM = "Custom";
const char* S_VOLTAGE = "Voltage:";
const char* S_GTIME = "Means time:";
const char* S_ERROR = "Error:";
const char* S_POFF = "Power management";
const char* S_SURE = "Sure?";
const char* S_ABOUT = "About";
const char* S_SENSOR_AREA = "Sensor area:";
...
const char* T_MR = "mR";
const char* T_R = "R";
const char* T_PCCM2 = "p/cm2";
const char* T_CPS = "cps";
const char* T_MAX = "max";
const char* T_OLD = "old";

const char* T_CURSOR = ">";

#endif /* S_INC_LANGUAGE_H_ */
